                    ...
                    <ul class="navbar-nav mr-auto">
                       <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a href="{{url('/complains')}}" class="dropdown-item">
                                <i class="fa fa-list"></i> Complain List
                            </a>
                            <a href="{{url('/complains/add')}}" class= "dropdown-item">
                    ...
                    <ul class="navbar-nav mr-auto">
                       <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="{{url('/products/add')}}" class= "dropdown-item">
                    ...
                    <ul class="navbar-nav mr-auto">
                       <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="{{url('/customers/add')}}" class= "dropdown-item">
